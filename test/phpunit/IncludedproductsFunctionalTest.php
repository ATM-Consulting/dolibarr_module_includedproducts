...
/**
 * \file    test/phpunit/IncludedproductsFunctionalTest.php
...
/**
 * Class IncludedproductsFunctionalTest
 *
 ...
 *
 * @package Testincludedproducts
 */
class IncludedproductsFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modIncludedproducts')->click();
		} else {
			// Disable the module
			$this->byHref('modIncludedproducts')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/includedproducts/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('includedproducts/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/includedproducts/admin/about.php');
		$this->authenticate();
		return $this->assertContains('includedproducts/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('includedproductswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modIncludedproducts_IncludedproductsTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modIncludedproducts_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
